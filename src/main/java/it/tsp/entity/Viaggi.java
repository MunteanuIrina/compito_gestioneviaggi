...
public class Viaggi {
    ...
    @Column(length = 45, nullable = false,name = "data_partenza")
    private String dataPartenza;

    @Column(length = 45, nullable = false,name = "data_ritorno")
    private String dataRitorno;

    @Column(length = 45, nullable = false,name = "posti_disponibili")
